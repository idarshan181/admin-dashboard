...
const Colors = {
  DEFAULT:
    'bg-blue-700 text-white hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 dark:border-blue-500 dark:text-blue-500',
  SUCCESS:
    'bg-green-700 text-white hover:bg-green-800 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 dark:border-green-500 dark:text-green-500',
  ERROR:
...
const OutlineColors = {
  DEFAULT:
    'text-blue-700 hover:text-blue-700 border-blue-700 hover:bg-blue-200 focus:ring-blue-300 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-600 dark:focus:ring-blue-800',
  SUCCESS:
...
const TextColors = {
  DEFAULT:
    'text-blue-700 hover:text-blue-700 border-blue-700 hover:bg-blue-200 focus:ring-blue-300 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-600 dark:focus:ring-blue-800',
  SUCCESS:
    'text-green-700 hover:text-green-700 border-green-700 hover:bg-green-200 focus:ring-green-300 dark:border-green-500 dark:text-green-500 dark:hover:text-white dark:hover:bg-green-600 dark:focus:ring-green-800',
  ERROR:
    'text-red-700 hover:text-red-700 border-red-700 hover:bg-red-200 focus:ring-red-300 dark:border-red-500 dark:text-red-500 dark:hover:text-red-700 dark:hover:bg-red-200 dark:focus:ring-red-800',
  ...
  INFO: 'text-cyan-700 hover:text-white border-cyan-700 hover:bg-cyan-800 focus:ring-cyan-300 dark:border-cyan-400 dark:text-cyan-400 dark:hover:text-white dark:hover:bg-cyan-500 dark:focus:ring-cyan-900',
  NEUTRAL:
    'text-gray-900 hover:bg-gray-200 border-gray-800 focus:ring-gray-300 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800'
} as const;
